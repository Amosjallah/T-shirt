              ...
              <div className="pt-4 border-t border-gray-200 space-y-3">
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${settings.readableFont ? 'bg-blue-700' : 'bg-gray-300'
                      }`}
                  >
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${settings.hideImages ? 'bg-blue-700' : 'bg-gray-300'
                      }`}
                  >
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${settings.highlightLinks ? 'bg-blue-700' : 'bg-gray-300'
                      }`}
                  >
